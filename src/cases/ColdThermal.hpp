...
///WARNING: these functors, taken from Clark Farley 1984, are for dry air!!
    ...
    class ColdThermalCommon : public CasesCommon<case_ct_params_t, n_dims>
    {
...
*/
    ...
    class ColdThermal<case_ct_params_t, 2> : public ColdThermalCommon<case_ct_params_t, 2>
    {
      using parent_t = ColdThermalCommon<case_ct_params_t, 2>;
      using ix = typename case_ct_params_t::ix;
      using rt_params_t = typename case_ct_params_t::rt_params_t;
...
//        arr_1D_t p_d_e(p_e - detail::calc_p_v()(p_e, rv_e));
      ...
      public:
      ColdThermal(const real_t _X=-1, const real_t _Y=-1, const real_t _Z=-1)
      {
    ...
    template<class case_ct_params_t>
    class ColdThermal<case_ct_params_t, 3> : public ColdThermalCommon<case_ct_params_t, 3>
    {
      using parent_t = ColdThermalCommon<case_ct_params_t, 3>;
      using ix = typename case_ct_params_t::ix;
      using rt_params_t = typename case_ct_params_t::rt_params_t;
